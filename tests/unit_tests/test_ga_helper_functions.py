...
from tests.util import project_root, get_files_with_suffix, csv_data_solution_factory
...
class TestGACrossover(unittest.TestCase):
    ...
    def test_crossover(self):
        ...
        for i, fjs_instance in enumerate(random.choices(fjs_data, k=num_choices)):
            ...
            try:
                factory = SolutionFactory(instance_data)
                for _ in range(50):
                    parent1 = factory.get_solution()
                    parent2 = factory.get_solution()
