...
class TestMakespan(unittest.TestCase):
    ...
    def test_makespan_integrity1(self):
        with open(self.project_root + '/tests/operation_matrices/operation_matrix1.pkl', 'rb') as fin:
    ...
    def test_makespan_integrity2(self):
        with open(self.project_root + '/tests/operation_matrices/operation_matrix2.pkl', 'rb') as fin:
            operation_matrix = pickle.load(fin)
    ...
    def test_makespan_integrity3(self):
        with open(self.project_root + '/tests/operation_matrices/operation_matrix3.pkl', 'rb') as fin:
            operation_matrix = pickle.load(fin)
    ...
    def test_makespan_integrity4(self):
        with open(self.project_root + '/tests/operation_matrices/operation_matrix4.pkl', 'rb') as fin:
            operation_matrix = pickle.load(fin)
    ...
    def test_makespan_integrity5(self):
        with open(self.project_root + '/tests/operation_matrices/operation_matrix5.pkl', 'rb') as fin:
            operation_matrix = pickle.load(fin)
